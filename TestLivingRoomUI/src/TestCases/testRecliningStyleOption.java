...
public class testRecliningStyleOption extends testMenuOption {
//********************************************************************
// MAIN
//********************************************************************		
...
obj2.navToLivingRoomPage();
//CLICK ON SECTIONAL STYLE OPTION
driver.findElement(By.xpath("/html/body/div[3]/main/div/div[2]/div/div[2]/div[3]/div[1]/div/ul/li[3]/a/span[1]")).click();
Thread.sleep(2000);
String url6 = driver.getCurrentUrl();

//CAPTURE CURRENT URL AND VERIFY THAT THE RECLINING STYLE LIVING ROOM OPTIONS PAGE LOADS
if(url6.contentEquals("https://www.roomstogo.com/furniture/Living-Rooms/Living-Room-Sets/_/N-8ewZ1z141xu?qf=styles_Reclining")) {
	System.out.println("https://www.roomstogo.com/furniture/Living-Rooms/Living-Room-Sets/_/N-8ewZ1z141xu?qf=styles_Reclining was found ");
}
else {
